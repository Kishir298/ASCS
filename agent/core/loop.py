...
class AgentLoop:
    ...
    def _project_prompt_block(self) -> str:
        ...
        """
        try:
            from agent.context.project import ProjectStore, project_prompt_text
        ...
        try:
            ...
            if resume:
                ...
                if persisted and len(persisted) and not persisted.all_complete:
                    target = persisted
                    from agent.execution.executor import TaskExecutor as _TE
    ...
    def _plan_objective(self, objective: str, store) -> dict:
        ...
        from agent.planning.planner import planner_prompt
        ...
        try:
            ...
            raw = "{}"
        from agent.planning.planner import parse_tasks
    ...
    def _build_executor(self, store) -> TaskExecutor:
        ...
        from agent.context.index import git_status as _git_status
